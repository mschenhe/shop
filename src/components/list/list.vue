<template>
    <div id="list">
      ...
      <ul>
        ...
        <li class="menu-item" v-for="(item,index) in this.bookSorts" :key="index" :class="{'current':currentIndex===index}" @click="selectMenu(index,$event)">
          <span class="text">
               {{item}}
           </span>
        </li>
    ...
    <div class="foods-wrapper" ref="foodsWrapper" >
      <ul>
        <li class="food-list food-list-hook" v-for="(item,index) in this.listData" :key="index">
          ...
          <ul v-for="(x,y) in item.list" :key="y">
            <router-link :to="{name:'goods',params:{'goods':x}}" class="food-item">
              <div class="icon">
                <img width="100" height="100" :src="x.img">
              </div>
              <div class="content">
...
export default {
  ...
  methods: {
    ...
    getSort(index) {
      console.log(document.getElementById("all")); //[index].style.background = "red";
